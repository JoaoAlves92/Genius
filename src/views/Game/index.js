...
export default function Game() {
    ...
    function botaoBeep(num, user=false) {
        if (num == 0) {
            setPressionado(0)
            let som = new Sound(require("../../assets/sounds/som-1.mp3"), (error, sound) => {
                if (error) {
                    alert(error)
                    return;
                }
            ...
            setPressionado(1)
            let som = new Sound(require("../../assets/sounds/som-2.mp3"), (error, sound) => {
                if (error) {
                    alert(error)
                    return;
                }
            ...
            setPressionado(2)
            let som = new Sound(require("../../assets/sounds/som-3.mp3"), (error, sound) => {
                if (error) {
                    alert(error)
                    return;
                }
            ...
            setPressionado(3)
            let som = new Sound(require("../../assets/sounds/som-4.mp3"), (error, sound) => {
                if (error) {
                    alert(error)
                    return;
                }
